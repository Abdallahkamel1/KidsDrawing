...
import com.example.heartpredictorapp.adapters.ParentRequestDoctorAdapter;
...
public class ParentAllDoctorsActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    ArrayList<Doctor> doctorArrayList;
    ParentViewDoctorAdapter doctorAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_all_doctors);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                doctorAdapter = new ParentViewDoctorAdapter(getApplicationContext(), doctorArrayList);
                recyclerView.setAdapter(doctorAdapter);
