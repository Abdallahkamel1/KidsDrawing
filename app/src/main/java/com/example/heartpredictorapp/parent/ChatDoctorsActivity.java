...
import com.example.heartpredictorapp.adapters.ParentChatDoctorAdapter;
...
public class ChatDoctorsActivity extends AppCompatActivity {
    ...
    ParentChatDoctorAdapter doctorAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                doctorAdapter = new ParentChatDoctorAdapter(getApplicationContext(), doctorArrayList);
                recyclerView.setAdapter(doctorAdapter);
