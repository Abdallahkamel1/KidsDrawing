...
import com.example.heartpredictorapp.adapters.ParentViewDoctorAdapter;
...
public class ChatParentActivity extends AppCompatActivity {
    TextView txtName;
    ...
    String doctorID, doctorName, parentID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtName.setText("Chat with " + doctorName);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren() ){
                    ...
                    if(chat.getParentID().equals(parentID) && chat.getDoctorID().equals(doctorID)){
                        if(chat.getSenderType().equals("parent")){
                ...
                adapter = new ItemArrayAdapter(getApplicationContext(), messages, "parent");
    ...
    public void AddMessage() {
        ...
        databaseMSG.addListenerForSingleValueEvent(new ValueEventListener() {
                 ...
                 public void onDataChange(@NonNull DataSnapshot snapshot) {
                     ...
                     Chat chat = new Chat(id, parentID, doctorID, msgTxt, shareDate, "parent");
