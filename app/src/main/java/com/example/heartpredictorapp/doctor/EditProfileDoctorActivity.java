...
public class EditProfileDoctorActivity extends AppCompatActivity {
    ...
    String strID, strName, strEmail, strPhone, strPass, strState;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPhone.getEditText().setText(LoginActivity.doctor.getDoctorPhone());
        txtName.getEditText().setText(LoginActivity.doctor.getDoctorName());
        txtPass.getEditText().setText(LoginActivity.doctor.getDoctorPass());
    ...
    public void EditUser(){
        ...
        databaseUsers.addListenerForSingleValueEvent(new ValueEventListener() {
                 ...
                 public void onDataChange(@NonNull DataSnapshot snapshot) {
                     ...
                     strEmail = LoginActivity.doctor.getDoctorEmail();
                     strState = LoginActivity.doctor.getDoctorState();
                     DatabaseReference dR = FirebaseDatabase.getInstance().getReference("doctor").child(strID);
                     Doctor user = new Doctor(strID, strName, strEmail, strPhone, strPass, strState);
                     dR.setValue(user);
                     progress.setVisibility(View.INVISIBLE);
                     LoginActivity.doctor.setDoctorName(strName);
                     LoginActivity.doctor.setDoctorPhone(strPhone);
                     LoginActivity.doctor.setDoctorPass(strPass);
