...
import com.example.heartpredictorapp.adapters.DoctorAllParentsAdapter;
import com.example.heartpredictorapp.adapters.ParentAdapter;
...
public class ViewAllParentsActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    ArrayList<Parent> parentArrayList;
    DoctorAllParentsAdapter parentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_all_parents);
        ...
        clearAll();
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("parent");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                parentAdapter = new DoctorAllParentsAdapter(getApplicationContext(), parentArrayList);
                recyclerView.setAdapter(parentAdapter);
