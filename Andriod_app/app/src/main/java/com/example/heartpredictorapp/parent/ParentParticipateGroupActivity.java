...
public class ParentParticipateGroupActivity extends AppCompatActivity {
    ...
    String parentID, parentName, shareDate;
    LocalDate currentDate;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_parent_participate_group);
        ...
        parentID = LoginActivity.parent.getParentID();
        parentName = LoginActivity.parent.getParentName();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            currentDate = LocalDate.now();
        }
        shareDate = String.valueOf(currentDate);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), ParentDiscussionGroupActivity.class);
                startActivity(i);
            }
        });
...
// Generate a new unique key for the new participation
        String id = databaseGroup.push().getKey();
// Create a new GroupParticipation object
        GroupParticipation user = new GroupParticipation(id, strID, "parent", parentID, parentName, shareDate, strParticipate);
// Save the new participation to the database
        databaseGroup.child(id).setValue(user)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(getApplicationContext(), "Failed to add participation", Toast.LENGTH_LONG).show();
                    }
                });
    }
}