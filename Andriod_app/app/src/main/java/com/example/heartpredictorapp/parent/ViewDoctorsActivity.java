...
public class ViewDoctorsActivity extends AppCompatActivity {
    ...
    ParentRequestDoctorAdapter doctorAdapter;
    ImageView imgBack, imgLogout, imgEditProfile;
    public static String strDrawID, strFile, strParentID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                doctorAdapter = new ParentRequestDoctorAdapter(getApplicationContext(), doctorArrayList);
                recyclerView.setAdapter(doctorAdapter);
