...
public class RequestAIAnalysisActivity extends AppCompatActivity {

    Interpreter tflite;
    String strFile, strDrawID, strParentID, strReportID;
    String fileUrl;
    TextView txtDiagnose, txtRecommend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_aianalysis);
        ...
        strDrawID = getIntent().getStringExtra("draw");
        strParentID = getIntent().getStringExtra("parent");
        strReportID = getIntent().getStringExtra("id");
        ...
        databaseUsers.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
             public void onDataChange(@NonNull DataSnapshot snapshot) {
                 ...
                 String doctorID = "0";
                 DatabaseReference dR = FirebaseDatabase.getInstance().getReference("report").child(strReportID);
                 Report report = new Report(strReportID, strDrawID, strParentID, doctorID, strFile, txtDiagnose.getText().toString(), txtRecommend.getText().toString(), uploadDate);
                 dR.setValue(report);
                 progress.setVisibility(View.INVISIBLE);
        ...
        databaseGroup.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot snap : snapshot.getChildren()) {
                    ...
                    if (groupsRecord.getDrawID().equals(strDrawID)) {
