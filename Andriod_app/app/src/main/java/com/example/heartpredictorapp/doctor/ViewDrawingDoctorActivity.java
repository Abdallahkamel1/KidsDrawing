...
public class ViewDrawingDoctorActivity extends AppCompatActivity {

    ImageView imgBack, imgLogout, imgEditProfile;
    String strFile, drawID, parentID, reportID, reportDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_drawing_doctor);
        ...
        btnAnalyze.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AddDiagnosisActivity.class);
